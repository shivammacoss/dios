    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          >
            <img 
              src={isDarkMode ? "/DiosDerivativewithoutsloganwhite.png" : "/DiosDerivativewithoutsloganblack.png"} 
    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 overflow-hidden">
        <video autoPlay muted loop playsInline className="absolute inset-0 w-full h-full object-cover" poster="/DiosDerivativelogowhite.png">
          <source src="/diosvideohomepage.mp4" type="video/mp4" />
        </video>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <motion.div ref={ref} initial={{ opacity: 0, x: -50 }} animate={isInView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.8 }}>
            <span className="inline-block px-4 py-2 bg-burgundy/10 text-burgundy dark:text-crimson-light rounded-full text-sm font-semibold mb-4">Why Choose Dios Derivatives</span>
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900 dark:text-white">
              A Platform Built for <span className="gradient-text block">Modern Traders</span>
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-400 mb-8">
              Dios Derivatives combines advanced technology, deep liquidity, and professional tools.
            </p>
  ...
  return (
    <section id="company" className="py-24 relative overflow-hidden dark:bg-gray-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <motion.div ref={ref} initial={{ opacity: 0, x: -50 }} animate={isInView ? { opacity: 1, x: 0 } : {}}>
            <span className="inline-block px-4 py-2 bg-burgundy/10 text-burgundy dark:text-crimson-light rounded-full text-sm font-semibold mb-4">About Dios Derivatives</span>
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900 dark:text-white">
              Next-Generation <span className="gradient-text block">Trading Platform</span>
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-400 mb-8">
              Dios Derivatives is a next-generation trading platform focused on providing traders with cutting-edge technology.
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="border-t border-white/10 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">© 2026 Dios Derivatives. All Rights Reserved.</p>
