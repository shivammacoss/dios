      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              Dios Derivatives is a next-generation trading platform focused on providing traders with cutting-edge technology, transparent pricing, and reliable execution. Our mission is to empower traders worldwide with tools that simplify trading and maximize potential.
            </motion.p>
