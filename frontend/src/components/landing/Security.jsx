      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              Your funds and data are protected with industry-leading security protocols. Dios Derivatives uses encrypted transactions, segregated accounts, and advanced monitoring systems to ensure complete protection at every step.
            </motion.p>
